...
///// <param name="filters">Diccionario de filtros exactos (usa AND)</param>
///// <param name="isActived">Filtro opcional por estado activo/inactivo</param>
///// <param name="globalSearchFields">Campos donde aplicar búsqueda general con LIKE</param>
//public class SqlFilterSpecification(Dictionary<string, object?>? filters, bool? isActived, List<string>? globalSearchFields = null)
//{
//    private readonly Dictionary<string, object?>? _filters = filters;
//    private readonly bool? _isActived = isActived;
//    private readonly List<string>? _globalSearchFields = globalSearchFields;
...
//        // 🔹 Filter global (AND)
//        if (_globalSearchFields != null && _globalSearchFields.Count > 0)
//        {
//            int index = 0;
//            var orConditions = new List<string>();

//            foreach (var field in _globalSearchFields)
//            {
//                string param = $"@like{index++}";
//                orConditions.Add($"{field} LIKE {param} COLLATE Latin1_General_CI_AI");
//                cmd.Parameters.AddWithValue(param, $"%{_filters?["search"] ?? ""}%");
//            }
